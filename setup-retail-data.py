...
"""
Sets up the TrustGraph retail UX demo workspace with knowledge graph
data, ontologies, queries, and tools.

Loads two complementary ontologies:
  - Retail product ontology (products, specifications, compatibility)
  - Interaction journey ontology (user journeys, decisions, signals)

Equivalent to the shell commands in datasets/retail-ux/README.md but
...
RETAIL_UX_DIR = os.path.join(DATASETS_DIR, "retail-ux")

ONTOLOGY_FILES = [
    "retail-ontology.ttl",
    "interaction-ontology.ttl",
]

DATA_FILES = [
    "retail-vocabulary.ttl",
    "retail-products-pc.ttl",
...
QUERY_FILES = [
    ("retail-queries.json", "retail SPARQL"),
    ("retail-agent-queries.json", "retail agent"),
    ("retail-graph-rag-queries.json", "retail GraphRAG"),
    ("interaction-queries.json", "interaction SPARQL"),
    ("interaction-agent-queries.json", "interaction agent"),
    ("interaction-graph-rag-queries.json", "interaction GraphRAG"),
]
